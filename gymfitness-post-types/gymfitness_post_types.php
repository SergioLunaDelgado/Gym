...
/* con este if hace que nadie pueda acceder a este archivo por la url */
if(!defined('ABSPATH')) die();

/* Registrar Custom Post Type, esto crea en el panel de admin una nueva opcion llamada clases */
function gymfitness_clases_post_type() {
	...
	$args = array(
		...
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail'), /* habilitar los paneles de edicion que tienen las entradas o paginas (custom-fields) */
		'hierarchical'          => true, // true = posts (del mas nuevo al mas viejo) , false = paginas (no importa el orden)
		'public'                => true, /* que los usuarios puedan verlo */
		'show_ui'               => true, /* se muestre en la interfaz de usaurio, panel de admin */
		'show_in_menu'          => true, /* se muestre en la interfaz de usaurio, modo edicion */
        'menu_position'         => 6, /* despues de las entradas, iniciando a contrar desde el 0 */
...
/* instructores Custom post, esto crea en el panel de admin una nueva opcion llamada instructores */
...
/* testimoniales Custom post, esto crea en el panel de admin una nueva opcion llamada instructores, no es nececsario usar advance custom fields */
